...
def index():
    if request.method == "POST":
        ...
        if job_desc_file and job_desc_file.filename:
            job_desc_text = extract_text_from_pdf(job_desc_file)  # Use utils.py
            print(f"Job description text: {job_desc_text[:100]}")  # Debug
        ...
        for f in resume_files:
            ...
            print(f"Resume: {f.filename}, Text: {text[:100]}, Email: {email}")  # Debug
